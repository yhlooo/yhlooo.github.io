...
后来我的 3B+ 被我不小心短接了 GPIO 的 3.3V 和 5V 针脚，就坏了，送修之后催了几次也没个结果，再后来就不想管了。之后也没有再买，因为一直觉得没什么意思，虽然偶尔会遇到“这时如果有个树莓派就好了”的情况，但是多数也不是很重要的，也有其它解决方法。像软路由这种应用场景，我后来找了一个 x86 的工控主板做了一个，具体可以看这篇文章 [软路由与 NAS (1) - 硬件平台搭建](router1-hardware.md) 。
